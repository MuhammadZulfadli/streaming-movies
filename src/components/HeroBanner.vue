  ...
  if (props.drama.episodes && props.drama.episodes.length > 0) {
    router.push({
      ...
      params: {
        ...
        episodeId: props.drama.episode.id
      }
    })
  }
}
...
<template>
  <div class="relative w-full h-[500px] md:h-[600px] overflow-hidden">
    ...
    <div class="absolute inset-0">
      <img :src="drama.banner || drama.poster" class="w-full h-full object-cover" alt="Hero Banner" />
      <!-- Gradient Overlay -->
    ...
    <div class="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-end pb-16 md:pb-24">
      <div class="max-w-2xl">
        <div class="flex items-center gap-2 mb-4">
          <span
            class="bg-rose-600 text-white text-xs font-bold px-2 py-1 rounded uppercase tracking-wider">Trending</span>
